...
/**
 * Controller for generating blog posts using detailed system guidelines.
 */
@RestController
...
public class ArticleController {
	...
	/**
	 * Endpoint that generates a blog post for a given topic based on specific
	 * guidelines.
	 *
	 * @param topic The subject of the blog post.
	 * @return A complete, ready-to-publish blog post.
	 */
